...
export const voiceDebug = () => Object.fromEntries([...peers].map(([id, p]) => [id, p.pc.connectionState + '/' + p.pc.signalingState]));
globalThis.__voicePcs = () => [...peers.values()].map((p) => p.pc);   // stats probes (voice-matrix)
