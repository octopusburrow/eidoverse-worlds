...
export function initEmoteBar() {
  ...
  const TILE = 34, GAP = 4, PAD = 5, ROW_H = 34;   // 09-05 21:51: tighter around the glyph — must match .tiles.fixed in index.html   // glyph-only tiles; name + key are the tooltip (R, 09-04)
